...
Kane is a professional JUCE audio instrument plugin for macOS and iOS.

## Overview

This repository contains the complete implementation of the Kane instrument, including:
...
```bash
# Clone repository
git clone git@github.com:bretbouchard/kane-instrument.git
cd kane-instrument
...
Kane instrument for White Room.
...
./render_instrument.sh kane
```

## Repository Information

- **Repository**: https://github.com/bretbouchard/kane-instrument
